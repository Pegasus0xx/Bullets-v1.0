...
grep -Pv "(w3|android|github|www\.google\.com|google\.com|mozilla\.org|schemas\.android|goo\.gl|apache\.org|ns\.adobe\.com|schemas\.microsoft\.com|developer\.apple\.com|apple\.com|jetbrains\.com)"
